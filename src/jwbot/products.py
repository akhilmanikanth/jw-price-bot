...
PRODUCTS: tuple[ProductSpec, ...] = (
    ...
    ProductSpec(
        ...
        search_term="johnnie walker black label 1 litre",
        name_tokens=("johnnie", "walker", "black"),
        size_tokens=SIZE_1L,
    ...
    ProductSpec(
        ...
        search_term="johnnie walker blue label 700ml",
    ...
    ProductSpec(
        ...
        search_term="ballantines finest 700ml",
    ...
    ProductSpec(
        ...
        search_term="ballantines finest 1 litre",
        name_tokens=("ballantine", "finest"),
        size_tokens=SIZE_1L,
        exclude_tokens=("700",),
        brief=True,
    ...
    ProductSpec(
        ...
        search_term="ballantines 12 year old 700ml",
